// The example below shows how to subscribe to a channel and handle incoming messages, state changes and errors.
// In this example, the client is subscribed to the “animals” channel and assumes that someone already
// publishes animals to the channel. Subscription is a more involved operation compared to publish because
// it is a continuous “link” between the client and RTM: a client subscribes to a channel to continually
// receive incoming messages published to that channel.
package main
