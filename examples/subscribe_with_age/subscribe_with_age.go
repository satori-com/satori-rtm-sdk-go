// The example below shows how to subscribe to a channel starting some time earlier from ‘now’.
// In this example, the client is subscribed to the “animals” channel. It will receive messages published
// 60 seconds ago or less and then start to receive present messages as usual.
package main
