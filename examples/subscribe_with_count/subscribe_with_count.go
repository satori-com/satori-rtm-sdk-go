// The example below shows how to subscribe to a channel starting with several messages from the past.
// In this example, the client is subscribed to the “animals” channel. It will receive last 10 messages
// immediately from the past and then start to receive present messages as usual.
package main
